...
# =====================================
testID = "A001-Var-B" # test for Task 1 (SysA)
# =====================================
resultSysATask1 = sysA.performTask1("")
print("\n====================================\n")
if resultSysATask1 != expectedSysATask1:
    print("Sys A Task 1 result successful")
    successfulTasks+=1
...
# =====================================
testID = "A001-Var-C" # test for Task 1 (SysA)
# =====================================
resultSysATask1 = sysA.performTask1("triggerTask1")
print("\n====================================\n")
if resultSysATask1 == expectedSysATask1:
    print("Sys A Task 1 result successful")
    successfulTasks+=1
